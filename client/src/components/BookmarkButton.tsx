...
export function BookmarkButton({ entityId, entityType }: BookmarkButtonProps) {
  ...
  return (
    <button
      ...
      className={`rounded-full px-3 py-2 text-xs font-semibold transition ${bookmarked ? 'bg-sura-gold text-sura-dark' : 'border border-sura-ivory/20 bg-sura-dark/80 text-sura-ivory/80 hover:border-sura-gold/60'}`}
    >
