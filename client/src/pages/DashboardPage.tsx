  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <header className="rounded-3xl border border-sura-ivory/10 bg-sura-ink/80 p-8">
        ...
        <p className="mt-3 text-sm leading-7 text-sura-ivory/80">{locale === 'ar' ? 'مركز تحكمك الشخصي للكتب والمفضلات والمشتريات.' : 'Your hub for bookmarks, reading progress, and purchases.'}</p>
      </header>
        ...
        <section className="rounded-3xl border border-sura-ivory/10 bg-black/30 p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-sura-ivory/70">{user?.role}</div>
            </div>
          </div>
          <div className="mt-6 space-y-3 text-sm text-sura-ivory/80">
